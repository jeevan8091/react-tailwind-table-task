        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
            {stats.map((stat) => (
              <article
                key={stat.label}
                className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 hover:border-blue-600/20 hover:shadow-md"
              >
                ...
                <p className="mt-3 text-xs font-normal text-slate-500">{stat.description}</p>
              </article>
            ))}
          </div>
          ...
          <section className="mt-6 border-t border-slate-100 pt-6">
            ...
            <p className="mt-1 text-sm font-normal text-slate-500">Frequently used shortcuts for admin workflow.</p>
            <div className="mt-4 grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              <Link
                to="/users"
                className="group flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 hover:border-blue-600/20 hover:shadow-md"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-800 transition-colors group-hover:text-blue-600">Go to Users</p>
                    <p className="mt-0.5 text-xs font-normal text-slate-400">View and manage directory</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-slate-800 transition-colors group-hover:text-blue-600">Employee Form</p>
                    <p className="mt-0.5 text-xs font-normal text-slate-400">Create employee records</p>
                  </div>
                </div>
                <span className="text-lg font-semibold text-slate-400 transition-colors group-hover:text-blue-600">→</span>
              </Link>
